...
A Python + SQL integrated GUI project that helps teachers record, analyze, and visualize student marks efficiently.  
The project combines **Tkinter**, **NumPy**, **Matplotlib**, and **SQLite** for data management, visualization, and analytics.
